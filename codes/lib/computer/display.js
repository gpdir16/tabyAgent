...
// xvfb_gui 도구와 웹 "컴퓨터" 화면이 같은 세션 파일(/tmp/tabyagent-xvfb/session.json)을
...
export const SESSIONS_DIR = "/tmp/tabyagent-xvfb";
export const SHOTS_DIR = "/tmp/tabyagent-xvfb/screenshots";
...
// 좀비가 남지 않고, pid 추적도 정확하다. 로그는 /tmp/tabyagent-xvfb/xvfb.log로.
...
export async function newSession(geometry) {
    ...
    return { error: `Failed to start Xvfb on :${DISPLAY}..:${DISPLAY + 4}. Check /tmp/tabyagent-xvfb/xvfb.log` };
}
