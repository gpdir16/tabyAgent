...
- Always send a `User-Agent` (e.g. `-A "tabyAgent/1.0"`). Empty UA gets blocked.
...
```bash
curl -sS -A "tabyAgent/1.0" "https://api.fxtwitter.com/2/status/1548602399862013953?lang=ko"
curl -sS -A "tabyAgent/1.0" "https://api.fxtwitter.com/2/search?q=from%3Aelonmusk&feed=latest&count=20"
curl -sS -A "tabyAgent/1.0" "https://api.fxtwitter.com/2/conversation/1548602399862013953?ranking_mode=recency"
curl -sS -A "tabyAgent/1.0" "https://api.fxtwitter.com/2/profile/elonmusk"
```
